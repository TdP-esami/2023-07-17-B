...
public class GOsalesDAO {
	...
	public List<Products> getNodes(String productType) {
	...
	public List<Arco> getEdges(String type, Integer year){
		...
		String query = "select " +
				...
				"  count(distinct gds1.Retailer_code) as n " +
				"from " +
				"  go_products gp1, " +
				"  go_products gp2, " +
				"  go_daily_sales gds1, " +
	...
	public List<String> getAllTypes() {
		String query = "select distinct(Product_type) as t from go_products";
	...
	public List<String> getAllBrands() {
		String query = "select distinct(Product_brand) as t from go_products";
